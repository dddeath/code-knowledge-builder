...
- **artifact_state**：位于 `prototypes/ckb-canvas-skill/ckb_canvas/contracts.py:212-221`。
...
- **CanvasSuccess**：位于 `prototypes/ckb-canvas-skill/ckb_canvas/contracts.py:268-277`。
