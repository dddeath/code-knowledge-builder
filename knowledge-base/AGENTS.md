...
- 命令入口：`C:\Users\19739\.codex\skills\code-knowledge-builder\scripts\ckb.py`
...
```powershell
& 'C:\Users\19739\.codex\cache\code-knowledge-builder\runtime\win-x64\win-x64-2.0.0\python\python.exe' 'C:\Users\19739\.codex\skills\code-knowledge-builder\scripts\ckb.py' brief --out 'E:\knowledge_builder\self-workspace\knowledge-base' "QUESTION" --budget 1800 --max-pages 8 --profile fast
```

2. 若 `open_feedback` 大于零，再列出开放反馈；任务涉及其目标页时按 `error`、`warn`、`suggest`、`info` 的固定优先级处理：

```powershell
& 'C:\Users\19739\.codex\cache\code-knowledge-builder\runtime\win-x64\win-x64-2.0.0\python\python.exe' 'C:\Users\19739\.codex\skills\code-knowledge-builder\scripts\ckb.py' feedback list --out 'E:\knowledge_builder\self-workspace\knowledge-base' --status open
```
...
```powershell
& 'C:\Users\19739\.codex\cache\code-knowledge-builder\runtime\win-x64\win-x64-2.0.0\python\python.exe' 'C:\Users\19739\.codex\skills\code-knowledge-builder\scripts\ckb.py' record --out 'E:\knowledge_builder\self-workspace\knowledge-base' --kind analysis --title 'TITLE' --body 'BODY.md' --from-pack 'PACK.json'
```
...
```powershell
& 'C:\Users\19739\.codex\cache\code-knowledge-builder\runtime\win-x64\win-x64-2.0.0\python\python.exe' 'C:\Users\19739\.codex\skills\code-knowledge-builder\scripts\ckb.py' gaps list --out 'E:\knowledge_builder\self-workspace\knowledge-base' --status open
```

7. 人工反馈通过 `feedback create` 进入带行范围和文本窗口的收件箱。处理前先执行：

```powershell
& 'C:\Users\19739\.codex\cache\code-knowledge-builder\runtime\win-x64\win-x64-2.0.0\python\python.exe' 'C:\Users\19739\.codex\skills\code-knowledge-builder\scripts\ckb.py' feedback locate --out 'E:\knowledge_builder\self-workspace\knowledge-base' --feedback 'FEEDBACK_ID'
```
...
```powershell
& 'C:\Users\19739\.codex\cache\code-knowledge-builder\runtime\win-x64\win-x64-2.0.0\python\python.exe' 'C:\Users\19739\.codex\skills\code-knowledge-builder\scripts\ckb.py' maintain --out 'E:\knowledge_builder\self-workspace\knowledge-base'
```
